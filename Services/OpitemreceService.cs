...
{
    public interface IOpitemreceService
    {
        Task OpitemreceSyncAsync<T>(DbSet<T> sourceTable, DbSet<T> targetTable, DateTime startDate, DateTime endDate, string KeyId, string WhereKey)
            where T : class;
    }

    public class OpitemreceService : IOpitemreceService
    {
        private readonly DataContext _dataContext;
        private readonly HisContext _hisContext;
        private readonly IMapper _mapper;

        public OpitemreceService(DataContext dataContext, HisContext hisContext, IMapper mapper)
        {
        ...
        public async Task OpitemreceSyncAsync<T>(DbSet<T> sourceTable, DbSet<T> targetTable, DateTime startDate, DateTime endDate, string KeyId, string WhereKey)
            where T : class
        {
